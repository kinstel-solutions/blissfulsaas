          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-16 lg:gap-32 text-center md:text-left">
             ...
             <div className="w-full md:w-1/2 space-y-6 md:space-y-8">
                ...
                <div className="pt-2 md:pt-4">
                  <button className="flex items-center justify-center md:justify-start gap-2 mx-auto md:mx-0 text-xs font-bold uppercase tracking-[0.2em] text-primary border-b border-primary/20 pb-2 hover:border-primary transition-all">
