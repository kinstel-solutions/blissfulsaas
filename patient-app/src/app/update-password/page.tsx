...
import { Lock, Fingerprint, Loader2, Eye, EyeOff } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center p-4 md:p-8 relative z-10 pt-32 pb-20">
        <div className="w-full max-w-xl">
          <div className="text-center mb-10">
            ...
            <p className="text-[#1A2F28]/60 text-sm font-medium uppercase tracking-[0.2em]">Secure your Station Account</p>
          </div>
