                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className={`flex items-center gap-1.5 text-[10px] md:text-xs font-medium ${unreadCount > 0 ? 'text-primary' : 'text-slate-400'}`}>
                      ...
                      {mounted ? new Date(s.scheduledAt).toLocaleDateString('en-US', { timeZone: 'UTC' }) : 'Loading...'}
                    </div>
                  </div>
                </button>
              );
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-4 md:space-y-6">
              {loading && messages.length === 0 ? (
                ...
                <div className="flex flex-col h-full items-center justify-center text-slate-300 opacity-50 space-y-2">
                  ...
                  <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-center">No messages in this thread</p>
                </div>
              ) : (
                messages.map((m) => {
