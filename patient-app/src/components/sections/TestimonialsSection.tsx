...
const testimonials = [
  { text: '"Very good experience. I think this is the first place where I found genuinely ethical, professional, and compassionate therapy. Highly recommended."', name: 'Pooja Singh' },
  ...
  { text: '"Good experience. Therapy is very scary for a first timer but they made me feel very comfortable. It\'s difficult to find such high standards of ethical care elsewhere."', name: 'Ramsha Aijaz' },
  ...
  { text: '"The clinic provides one of the best mental health services, with the utmost ethical practice by the Clinical Psychologist."', name: 'Payal Sharma' },
