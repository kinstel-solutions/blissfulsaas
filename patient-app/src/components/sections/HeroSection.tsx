  ...
  return (
    <section
      ...
      <div className="flex flex-col items-center justify-center text-center max-w-[800px] mx-auto animate-in fade-in slide-in-from-bottom duration-1000">
        ...
        <p className="text-lg md:text-xl text-[var(--text-light)] mb-4 md:mb-10 max-w-[640px] leading-relaxed">
          {/* <span className="hidden md:inline">
            Experience professional, ethical care tailored to your unique
            mental health journey.{" "}
            // A clinical practice for individuals, couples, children and organisations. Online and in-person from Lucknow.
          </span> */}
