...
const stats = [
  { value: '100+', label: 'Verified Specialists', icon: <Heart className="w-6 h-6" /> },
  { value: '5000+', label: 'Sessions Completed', icon: <ShieldCheck className="w-6 h-6" /> },
  { value: '100%', label: 'Confidentiality', icon: <Lock className="w-6 h-6" /> },
  { value: '4.9/5', label: 'Patient Satisfaction', icon: <Star className="w-6 h-6" /> },
];
