  ...
  return (
    <div className="space-y-8 md:space-y-12 animate-in fade-in duration-700 px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
        {stats.map((stat, idx) => (
          <div key={idx} className="group bg-surface-container-lowest border border-outline-variant/20 p-6 md:p-8 rounded-xl shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 cursor-default relative overflow-hidden">
            ...
            <div className={`w-12 h-12 md:w-14 md:h-14 ${stat.bg} ${stat.color} rounded-xl flex items-center justify-center mb-6 border border-current/10 shadow-inner group-hover:rotate-6 transition-transform`}>
