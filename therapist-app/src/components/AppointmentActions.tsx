    ...
    <div className="contents lg:flex lg:items-center lg:justify-end lg:gap-2.5">
      {status === 'PENDING' && (
        <Button 
          ...
          disabled={loading}
          className="flex items-center justify-center gap-1.5 flex-1 lg:flex-initial lg:w-auto px-3 py-3 sm:px-4 sm:py-3 bg-slate-900 hover:bg-black text-white font-bold uppercase tracking-widest text-[10px] rounded-xl shadow-sm transition-all hover:shadow active:scale-95 disabled:opacity-50 disabled:pointer-events-none h-auto whitespace-nowrap shrink-0"
        >
      ...
      <Button 
        ...
        disabled={loading}
        className="flex items-center justify-center gap-1.5 flex-1 lg:flex-initial lg:w-auto px-3 py-3 sm:px-4 sm:py-3 bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 font-bold uppercase tracking-widest text-[10px] rounded-xl transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none h-auto whitespace-nowrap shrink-0"
      >
