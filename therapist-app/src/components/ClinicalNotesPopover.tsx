  ...
  return (
    <>
      <Button 
        ...
        className={`p-2 rounded-lg transition-all flex items-center gap-2 h-auto ${
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent showCloseButton={false} className="p-0 bg-white w-full max-w-lg rounded-xl shadow-2xl border border-slate-100 overflow-hidden sm:max-w-lg gap-0">
          ...
          <div className="p-4 md:p-8">
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <Button 
                onClick={saveNotes}
                disabled={loading}
                className={`flex items-center gap-2 px-6 py-3 rounded-2xl text-xs font-bold uppercase tracking-widest transition-all shadow-lg active:scale-95 h-auto ${
                  saved 
