          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-100">
                ...
                <th className="px-5 md:px-10 py-4 md:py-8 text-left text-xs font-bold uppercase tracking-[0.2em] text-slate-400">Contact Details</th>
                ...
                <th className="px-5 md:px-10 py-4 md:py-8 text-left text-xs font-bold uppercase tracking-[0.2em] text-slate-400">Last Session</th>
                ...
                <tr key={p.id} className="group hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-5 md:px-10 py-4 md:py-8">
                    <div className="flex items-center gap-2 text-sm text-slate-600">
                      ...
                      {new Date(p.latestSession).toLocaleDateString('en-US')}
